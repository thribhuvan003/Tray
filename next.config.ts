...
const securityHeaders = [
  ...
  // wide-public; for a campus canteen this is sane.
  {
    ...
    value: [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://qstash-eu-central-1.upstash.io https://qstash.upstash.io https://*.upstash.io https://api.razorpay.com https://checkout.razorpay.com",
