...
export function EditItemForm({
  ...
  const [preview, setPreview] = useState({
    ...
    price: priceRupees,
    diet: item.diet as "veg" | "nonveg" | "egg",
    image_url: item.image_url ?? "",
  });

  const [photoMode, setPhotoMode] = useState<"file" | "url">(
    item.image_url && !item.image_url.startsWith("data:") ? "url" : "file"
  );
    ...
    <div>
      ...
      <div className="flex flex-col lg:flex-row gap-10 items-start">
        <div className="w-full max-w-lg shrink-0">
          ...
          <div className="mt-12 border-t border-[var(--admin-line)] pt-6">
          ...
          >
            ...
            >
              ...
              <StudentCardPreview
                ...
                pricePaise={Math.round(parseFloat(preview.price || "0") * 100)}
                diet={preview.diet}
