      ...
      <Drawer.Portal>
        ...
        <Drawer.Content className="fixed bottom-0 left-0 right-0 z-50 mt-24 flex h-[88vh] sm:h-[80vh] flex-col rounded-t-3xl bg-[color:var(--color-paper)] focus:outline-none">
          ...
          <div className="px-5 sm:px-6 py-4 border-t border-[color:var(--color-line)] flex flex-col gap-3 bg-[color:var(--color-paper-dim)]">
            <div role="radiogroup" aria-label="Order type" className="grid grid-cols-2 gap-2 p-1 rounded-xl border border-[color:var(--color-line)] bg-[color:var(--color-paper)]">
              <button
                role="radio"
            ...
            <div className="flex items-center justify-between">
              <div>
                <div className="text-[11px] font-mono uppercase tracking-wider text-[color:var(--color-ink)]/55">Total · UPI</div>
