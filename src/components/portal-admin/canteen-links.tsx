    ...
    >
      ...
      <div className="flex items-center gap-1 shrink-0">
        <button
          ...
          onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.background = "var(--admin-bg-4)"; (e.currentTarget as HTMLElement).style.color = "var(--admin-ink)"; }}
      ...
      ? [
          {
            ...
            accentBg: "var(--admin-violet-soft)",
          } satisfies Link,
        ]
      : []),
  ];
  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center justify-between">
        <div>
          <h2 className="font-semibold font-display" style={{ fontSize: 13, color: "var(--admin-ink)" }}>
