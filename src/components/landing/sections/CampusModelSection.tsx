...
// Bidirectional access mapping definitions:
const ROLE_ACCESS_MAP: Record<number, readonly number[]> = {
  0: [0, 1, 2, 3], // Student -> All
  1: [0],          // Kitchen staff -> Main Canteen only
  2: [1],          // Canteen admin -> Hostel Mess only
  3: [0, 1, 2, 3], // Campus admin -> All
} as const;

const CANTEEN_ACCESS_MAP: Record<number, readonly number[]> = {
  0: [0, 1, 2, 3], // Main Canteen is accessed by all
  1: [0, 2, 3],    // Hostel Mess is accessed by Student, Admin, Campus Admin
  2: [0, 3],       // North Block is accessed by Student, Campus Admin
  3: [0, 3],       // Night Canteen is accessed by Student, Campus Admin
} as const;
    ...
    <SectionReveal as="div" id="campus" className="px-4 pt-16 pb-14 sm:px-8 sm:pt-24 sm:pb-20 lg:px-10 bg-[#FAF8F5] lg:min-h-screen lg:flex lg:flex-col lg:justify-center lg:py-24">
      <motion.div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-start">
          ...
          {/* Right Column: Roles & Visibility (Capsules) */}
          <div className="flex flex-col gap-6">
