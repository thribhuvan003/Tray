    ...
    <section className="px-5 py-24 sm:px-8 lg:px-10 bg-[#FAF8F5] border-b border-[var(--tray-border)] tl-arrival-host lg:min-h-screen lg:flex lg:flex-col lg:justify-center lg:py-24" id="where">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <div>
            <h2 className="leading-[0.88] tracking-[-0.04em] uppercase"
              style={{
            ...
            <p className="mt-6 max-w-xl text-[1.1rem] leading-8 text-neutral-600"
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <h3 className="mt-3 text-[1.4rem] font-medium tracking-tight font-editorial" style={{ fontFamily: "var(--font-fraunces)" }}>
                        {preview.title}
                      </h3>
                    </div>
                  ...
                  <div>
                    ...
                    <p className="text-[0.88rem] leading-[1.6] text-neutral-600 font-sans">
                      {preview.detail}
                    </p>
                  </div>
                </motion.div>
