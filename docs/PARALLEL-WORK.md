...
- **Clickable Portal Cards:** Wrapped all portal bento cards on the Next.js landing page inside anchor tags, making clicking anywhere on the card navigate to its respective demo portal. Replaced the nested launch demo link with a styled span to maintain valid, semantic HTML.
